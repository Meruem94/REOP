...
class MyTopo( Topo ):
	...
	def __init__( self ):
		...
		lefttopSwitch = self.addSwitch( 's1', listenPort=6634 )
		righttopSwitch = self.addSwitch( 's2', listenPort=6634 )
		leftbotSwitch = self.addSwitch( 's3', listenPort=6634 )
		rightbotSwitch = self.addSwitch( 's4', listenPort=6634 )
		# Add links
