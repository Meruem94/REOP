...
class MyTopo( Topo ):
	...
	self.addLink( righttopSwitch, lefttopSwitch )
	self.addLink( righttopSwitch, rightbotSwitch)
	self.addLink( leftbotHost1, leftbotSwitch )
	self.addLink( leftbotHost2, leftbotSwitch )
	self.addLink( leftbotSwitch, lefttopSwitch )
	self.addLink( leftbotSwitch, rightbotSwitch )
	...
	self.addLink( leftbotSwitch, righttopSwitch )
	self.addLink( rightbotSwitch, lefttopSwitch )
